...
This Event Manager is really very easier and flexible! 
If you have developed in C# this library will sound familiar.


Installation
------------

    composer require cybtow/event-manager "^0.2"
